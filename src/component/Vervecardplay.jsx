...
const Vervecardplay = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Verve card details submitted:', formData);
  };

  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-2xl font-bold text-center mb-6">Add Verve Card Payment</h2>
